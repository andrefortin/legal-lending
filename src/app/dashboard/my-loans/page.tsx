      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-600">
            View your active loans and manage payments
          </p>
        </div>
          ...
          <div className="flex">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-yellow-700">
                This page will show your active funded loans. Loans will appear here
                once applications are approved and funded by the lender.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white shadow overflow-hidden rounded-md">
            <div className="p-12 text-center text-gray-500">
              ...
              <p className="text-sm mb-6">
                Your funded loans will appear here.
              </p>
              <Link
